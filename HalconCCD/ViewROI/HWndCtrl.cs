...
namespace HalconCCD
{
	...
	public class HWndCtrl
	{
        #region  委托
        //鼠标抬起，匹配模板显示序号,九点仿射
        public delegate void dele_event_MouseUp(int num, PointF p);
        private dele_event_MouseUp m_event_disRoiCenter;
        public event dele_event_MouseUp event_disRoiCenter
        {
            add
            {
                if (m_event_disRoiCenter == null)
                {
                    m_event_disRoiCenter += value;
                }
            }
            remove
            {
        ...
        //鼠标抬起，显示活动ROI
        public delegate void dele_event_MouseUpROI(ROI actRoi);
        private dele_event_MouseUpROI m_event_disActiveROI;
        public event dele_event_MouseUpROI event_disActiveROI
        {
            add
            {
                if (m_event_disActiveROI == null)
                {
                    m_event_disActiveROI += value;
                }
            }
            remove
            {
        ...
        //显示当前鼠标位置
        public delegate void dele_event_disCurrentPoint(PointF point);
        private dele_event_disCurrentPoint m_event_disCurrentPoint;
        public event dele_event_disCurrentPoint event_disCurrentPoint
        {
            add
            {
                if (m_event_disCurrentPoint == null)
                {
                    m_event_disCurrentPoint += value;
                }
            }
            remove
            {
